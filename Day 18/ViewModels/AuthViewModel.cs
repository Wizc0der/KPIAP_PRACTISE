...
namespace HotelBooking.ViewModels
{
    public class AuthViewModel : BaseViewModel
    {
        ...
        public AuthViewModel(AuthService authService)
        {
            ...
            LoginCommand      = new AsyncRelayCommand(_ => DoLoginAsync());
        ...
        private async Task DoRegisterAsync()
        {
            ...
            try
            {
                var (success, message) = await _authService.RegisterManagerAsync(
                    Username, Password, RegFullName, RegEmail, RegPhone);
